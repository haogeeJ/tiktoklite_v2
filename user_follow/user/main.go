...
func main() {
	...
	pb.RegisterUserServiceServer(grpcServer, &Service{service.NewUserService()})
	//注册follow的服务
	follow.RegisterService(grpcServer)
	...
	registration := &api.AgentServiceRegistration{
		...
		Name:    setting.Conf.Consul.ServerNames[1],
