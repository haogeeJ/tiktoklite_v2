...
func UserLogin(ctx context.Context, req *pb2.UserLoginOrRegisterRequest) (*pb2.UserLoginOrRegisterResponse, error) {
	grpcClient := pb2.NewUserServiceClient(conn)
	return grpcClient.UserLogin(ctx, req)
}
func UserRegister(ctx context.Context, req *pb2.UserLoginOrRegisterRequest) (*pb2.UserLoginOrRegisterResponse, error) {
	grpcClient := pb2.NewUserServiceClient(conn)
	return grpcClient.UserRegister(ctx, req)
}
func RelationAction(ctx context.Context, req *pb3.RelationActionRequest) (*pb3.RelationActionResponse, error) {
	grpcClient := pb3.NewFollowServiceClient(conn)
	return grpcClient.RelationAction(ctx, req)
}
